...
public class CreateRelationFrame extends JDialog implements ActionListener{

	private static CreateRelationFrame currentDialog;
	...
	public static CreateRelationFrame getCurrentDialog() {
		if(currentDialog == null){
			currentDialog = new CreateRelationFrame();
		}
	...
	public static void showMessageDialog() {
		CreateRelationFrame cr = getCurrentDialog();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(src==btnOk){			
			...
			try {
				...
				Global.getInstance().getMainFrame().loadRelation(relation);
